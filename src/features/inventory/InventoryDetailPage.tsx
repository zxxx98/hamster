...
type Detail = { id: string; quantity: number; unit: string; low_stock_threshold: number; reminder_ignored: boolean; products: { name: string; specification: string | null; image_url: string | null }[]; storage_locations: { name: string; photo_path: string | null; rooms: { name: string }[] }[] }
